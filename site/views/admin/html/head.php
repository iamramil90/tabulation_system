...
<script type="text/javascript" src="<?php echo base_url('skin/admin/js/jquery.js') ?>"/></script>
<script type="text/javascript" src="<?php echo base_url('uikit/dist/js/uikit.min.js') ?>"/></script>
<script type="text/javascript" src="<?php echo base_url('skin/admin/js/angular.min.js') ?>"/></script>
