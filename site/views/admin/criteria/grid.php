<div class="uk-margin uk-clearfix">
    <button  data-uk-modal="{target:'#criteria'}" class="uk-float-right uk-button uk-button-primary"><i class="uk-icon-plus"></i>  New Criteria</button>
</div>

<table class="uk-table uk-table-striped" ng-controller="criteriacontrollergrid">
